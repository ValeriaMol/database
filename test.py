...
#катастрофы - Титаник     
            if call.message:
                if call.data == '1.1':
                    ...
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/2213/")
                    markup.add(item1)
...
#катастрофы - Выжить  
            if call.message:
                if call.data == '1.2':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/9298/")
                    markup.add(item1)
...
#катастрофы - Смерч 
            if call.message:
                if call.data == '1.3':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1722/")
                    markup.add(item1)
...
#катастрофы - Метро 
            ...
            if call.message:
                if call.data == '1.4':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/521689/")
                    markup.add(item1)
...
#катастрофы - Разлом 
            ...
            if call.message:
                if call.data == '1.5':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1094106/")
                    markup.add(item1)
...
#катастрофы - Туннель: Опасно для жизни
            ...
            if call.message:
                if call.data == '1.6':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1199016/")
                    markup.add(item1)
...
#катастрофы - И грянул шторм 
            ...
            if call.message:
                if call.data == '1.7':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/608559/")
                    markup.add(item1)
...
#катастрофы - В изоляции 
            ...
            if call.message:
                if call.data == '1.8':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/series/929690/")
                    markup.add(item1)
...
#катастрофы - Волна 
            ...
            if call.message:
                if call.data == '1.9':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/842950/")
                    markup.add(item1)
...
#катастрофы - Чёрный краб 
            ...
            if call.message:
                if call.data == '1.10':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/4438259/")
                    markup.add(item1)
...
#Комедии - Круэлла     
            if call.message:
                if call.data == '1.11':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/804662/")
                    markup.add(item1)
...
#Комедии - Мальчишник в Вегасе  
            if call.message:
                if call.data == '1.12':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/426004/")
                    markup.add(item1)
...
#Комедии - Мы - Миллеры 
            if call.message:
                if call.data == '1.13':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/582170/")
                    markup.add(item1)
...
#Комедии - Третий лишний 
            ...
            if call.message:
                if call.data == '1.14':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/507817/")
                    markup.add(item1)
...
#Комедии - Большой Лебовски 
            ...
            if call.message:
                if call.data == '1.15':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/555/")
                    markup.add(item1)
...
#Комедии - Впритык
            ...
            if call.message:
                if call.data == '1.16':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/464282/")
                    markup.add(item1)
...
#Комедии - Стажер 
            ...
            if call.message:
                if call.data == '1.17':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/677893/")
                    markup.add(item1)
...
#Комедии - Майор Пейн 
            ...
            if call.message:
                if call.data == '1.18':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/21503/")
                    markup.add(item1)
...
#Комедии - (НЕ)идеальный мужчина 
            ...
            if call.message:
                if call.data == '1.19':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1162847/")
                    markup.add(item1)
...
#Комедии - Почему он? 
            ...
            if call.message:
                if call.data == '1.20':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/930000/")
                    markup.add(item1)
...
#Боевики - Гнев человеческий     
            if call.message:
                if call.data == '1.21':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1318972/")
                    markup.add(item1)
...
#Боевики - Леон  
            if call.message:
                if call.data == '1.22':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/389/")
                    markup.add(item1)
...
#Боевики - Карты, деньги, два ствола 
            if call.message:
                if call.data == '1.23':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/522/")
                    markup.add(item1)
...
#Боевики - Бесславные ублюдки 
            ...
            if call.message:
                if call.data == '1.24':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/9691/")
                    markup.add(item1)
...
#Боевики - Майор Гром: Чумной Доктор 
            ...
            if call.message:
                if call.data == '1.25':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1109271/")
                    markup.add(item1)
...
#Боевики - Джон Уик
            ...
            if call.message:
                if call.data == '1.26':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/762738/")
                    markup.add(item1)
...
#Боевики - Троя 
            ...
            if call.message:
                if call.data == '1.27':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/3442/")
                    markup.add(item1)
...
#Боевики - Механик 
            ...
            if call.message:
                if call.data == '1.28':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/195615/")
                    markup.add(item1)
...
#Боевики - Стрелок 
            ...
            if call.message:
                if call.data == '1.29':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/257898/")
                    markup.add(item1)
...
#Боевики - Город грехов 
            ...
            if call.message:
                if call.data == '1.30':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/77443/")
                    markup.add(item1)
...
#Ужасы - Поезд в Пусан     
            if call.message:
                if call.data == '1.31':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/977288/")
                    markup.add(item1)
...
#Ужасы - Война миров Z  
            if call.message:
                if call.data == '1.32':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/261636/")
                    markup.add(item1)
...
#Ужасы - Добро пожаловать в Zомбилэнд 
            if call.message:
                if call.data == '1.33':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/427122/")
                    markup.add(item1)
...
#Ужасы - Заклятие 
            ...
            if call.message:
                if call.data == '1.34':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/468994/")
                    markup.add(item1)
...
#Ужасы - 28 дней спустя 
            ...
            if call.message:
                if call.data == '1.35':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/577/")
                    markup.add(item1)
...
#Ужасы - Мгла
            ...
            if call.message:
                if call.data == '1.36':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/273302/")
                    markup.add(item1)
...
#Ужасы - Мумия 
            ...
            if call.message:
                if call.data == '1.37':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/4484/")
                    markup.add(item1)
...
#Ужасы - Живое 
            ...
            if call.message:
                if call.data == '1.38':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/966995/")
                    markup.add(item1)
...
#Ужасы - Дракула 
            ...
            if call.message:
                if call.data == '1.39':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1727/")
                    markup.add(item1)
...
#Ужасы - Хижина в лесу 
            ...
            if call.message:
                if call.data == '1.40':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/419209/")
                    markup.add(item1)
...
#Мультфильмы - Лука     
            if call.message:
                if call.data == '1.41':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1395801/")
                    markup.add(item1)
...
#Мультфильмы - Моана  
            if call.message:
                if call.data == '1.42':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/837530/")
                    markup.add(item1)
...
#Мультфильмы - Ходячий замок 
            if call.message:
                if call.data == '1.43':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/49684/")
                    markup.add(item1)
...
#Мультфильмы - Унесенные призраками 
            ...
            if call.message:
                if call.data == '1.44':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/370/")
                    markup.add(item1)
...
#Мультфильмы - Король лев 
            ...
            if call.message:
                if call.data == '1.45':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/2360/")
                    markup.add(item1)
...
#Мультфильмы - Зов предков
            ...
            if call.message:
                if call.data == '1.46':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1060511/")
                    markup.add(item1)
...
#Мультфильмы - Валл-и 
            ...
            if call.message:
                if call.data == '1.47':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/279102/")
                    markup.add(item1)
...
#Мультфильмы - Корпорация монстров 
            ...
            if call.message:
                if call.data == '1.48':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/458/")
                    markup.add(item1)
...
#Мультфильмы - Мулан 
            ...
            if call.message:
                if call.data == '1.49':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/5277/")
                    markup.add(item1)
...
#Мультфильмы - Вокруг света за 80 дней 
            ...
            if call.message:
                if call.data == '1.50':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1264778/")
                    markup.add(item1)
...
#Приключения - Выживший     
            if call.message:
                if call.data == '1.51':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/522941/")
                    markup.add(item1)
...
#Приключения - Парк Юрского периода  
            if call.message:
                if call.data == '1.52':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/7121/")
                    markup.add(item1)
...
#Приключения - Анчартед: На картах не значится 
            if call.message:
                if call.data == '1.53':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/468373/")
                    markup.add(item1)
...
#Приключения - Кон - тики 
            ...
            if call.message:
                if call.data == '1.54':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/506432/")
                    markup.add(item1)
...
#Приключения - Круиз по джунглям 
            ...
            if call.message:
                if call.data == '1.55':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/462059/")
                    markup.add(item1)
...
#Приключения - Время первых
            ...
            if call.message:
                if call.data == '1.56':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/885316/")
                    markup.add(item1)
...
#Приключения - Тайны печати дракона 
            ...
            if call.message:
                if call.data == '1.57':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/840758/")
                    markup.add(item1)
...
#Приключения - Восточный ветер 
            ...
            if call.message:
                if call.data == '1.58':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/703187/")
                    markup.add(item1)
...
#Приключения - Эбигейл 
            ...
            if call.message:
                if call.data == '1.59':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/991656/")
                    markup.add(item1)
...
#Приключения - Эспен в королевстве троллей 
            ...
            if call.message:
                if call.data == '1.60':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/979362/")
                    markup.add(item1)
...
#Норвегия - Худший человек на свете
            ...
            if call.message:
                if call.data == '2.1':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/4479538/")
                    markup.add(item1)
...
#Норвегия - Тысячу раз «спокойной ночи»  
            if call.message:
                if call.data == '2.2':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/678392/")
                    markup.add(item1)
...
#Норвегия - Охотники за головами 
            if call.message:
                if call.data == '2.3':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/526812/")
                    markup.add(item1)
...
#Норвегия - Король чёртова острова 
            ...
            if call.message:
                if call.data == '2.4':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/466994/")
                    markup.add(item1)
...
#Норвегия - Гунда 
            ...
            if call.message:
                if call.data == '2.5':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1332702/")
                    markup.add(item1)
...
#Россия - Брат     
            if call.message:
                if call.data == '2.6':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/41519/")
                    markup.add(item1)
...
#Россия - Дурак  
            if call.message:
                if call.data == '2.7':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/808639/")
                    markup.add(item1)
...
#Россия - Легенда №17 
            if call.message:
                if call.data == '2.8':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/601564/")
                    markup.add(item1)
...
#Россия - О чём говорят мужчины 
            ...
            if call.message:
                if call.data == '2.9':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/468102/")
                    markup.add(item1)
...
#Россия - Огонь 
            ...
            if call.message:
                if call.data == '2.10':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1183599/")
                    markup.add(item1)
...
#Великобритания - Эмма     
            if call.message:
                if call.data == '2.11':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1244402/")
                    markup.add(item1)
...
#Великобритания - Три секунды  
            if call.message:
                if call.data == '2.12':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/651909/")
                    markup.add(item1)
...
#Великобритания - Гонка века 
            if call.message:
                if call.data == '2.13':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/808007/")
                    markup.add(item1)
...
#Великобритания - Две королевы 
            ...
            if call.message:
                if call.data == '2.14':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/696247/")
                    markup.add(item1)
...
#Великобритания - Код «Красный» 
            ...
            if call.message:
                if call.data == '2.15':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1102365/")
                    markup.add(item1)
...
#Франция - Расправь крылья     
            if call.message:
                if call.data == '2.16':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1256482/")
                    markup.add(item1)
...
#Франция - Прекрасная эпоха  
            if call.message:
                if call.data == '2.17':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1207666/")
                    markup.add(item1)
...
#Франция - Как прогулять школу с пользой 
            if call.message:
                if call.data == '2.18':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1032308/")
                    markup.add(item1)
...
#Франция - Приключения Реми 
            ...
            if call.message:
                if call.data == '2.19':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1108571/")
                    markup.add(item1)
...
#Франция - Обещание на рассвете 
            ...
            if call.message:
                if call.data == '2.20':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/938727/")
                    markup.add(item1)
...
#США - Побег из Шоушенка     
            if call.message:
                if call.data == '2.21':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/326/")
                    markup.add(item1)
...
#США - Начало  
            if call.message:
                if call.data == '2.22':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/447301/")
                    markup.add(item1)
...
#США - Темный рыцарь 
            if call.message:
                if call.data == '2.23':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/111543/")
                    markup.add(item1)
...
#США - Зеленая книга 
            ...
            if call.message:
                if call.data == '2.24':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1108577/")
                    markup.add(item1)
...
#США - Волк с Уолл-стрит 
            ...
            if call.message:
                if call.data == '2.25':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/462682/")
                    markup.add(item1)
...
# книги - Фантастические твари и где они обитают            
            if call.message:
                if call.data == '3.1':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/797840/")
                    markup.add(item1)
...
# книги - голодные игры
            if call.message:
                if call.data == '3.2':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/468581/")
                    markup.add(item1)
...
# книги - Марсианин
            if call.message:
                if call.data == '3.3':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/841700/")
                    markup.add(item1)
...
# книги - Бегущий в лабиринте
            ...
            if call.message:
                if call.data == '3.4':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/575613/")
                    markup.add(item1)
...
# книги - Дивергент
            ...
            if call.message:
                if call.data == '3.5':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/582101/")
                    markup.add(item1)
...
# книги - Сумерки
            ...
            if call.message:
                if call.data == '3.6':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/401177/")
                    markup.add(item1)
...
# книги - День триффидов
            ...
            if call.message:
                if call.data == '3.7':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/series/438271/")
                    markup.add(item1)
...
# книги - Я – легенда
            ...
            if call.message:
                if call.data == '3.8':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/195524/")
                    markup.add(item1)
...
# книги - Война миров
            ...
            if call.message:
                if call.data == '3.9':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/81289/")
                    markup.add(item1)
...
# книги - Властелин колец
            ...
            if call.message:
                if call.data == '3.10':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/328/")
                    markup.add(item1)
...
# Веселое - Отпуск по обмену            
            if call.message:
                if call.data == '4.1':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/104927/")
                    markup.add(item1)
...
# Веселое - Маска
            if call.message:
                if call.data == '4.2':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/6039/")
                    markup.add(item1)
...
# Веселое - Привет, Джули!
            if call.message:
                if call.data == '4.3':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/470037/")
                    markup.add(item1)
...
# Веселое - Мамма миа!
            ...
            if call.message:
                if call.data == '4.4':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/276478/")
                    markup.add(item1)
...
# Веселое - Октябрьское небо
            ...
            if call.message:
                if call.data == '4.5':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/2056/")
                    markup.add(item1)
...
# Веселое - Хорошо быть тихоней
            ...
            if call.message:
                if call.data == '4.6':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/523248/")
                    markup.add(item1)
...
# Веселое - Семья напрокат
            ...
            if call.message:
                if call.data == '4.8':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/85182/")
                    markup.add(item1)
...
# Веселое - 10 причин моей ненависти
            ...
            if call.message:
                if call.data == '4.9':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/11130/")
                    markup.add(item1)
...
# Веселое - Тайная жизнь пчел
            ...
            if call.message:
                if call.data == '4.10':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/195497/")
                    markup.add(item1)
...
# Грустное - Мальчик в полосатой пижаме            
            if call.message:
                if call.data == '4.11':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/281251/")
                    markup.add(item1)
...
# Грустное - Хорошие дети не плачут
            if call.message:
                if call.data == '4.12':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/607235/")
                    markup.add(item1)
...
# Грустное - Дневник памяти
            if call.message:
                if call.data == '4.13':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/3561/")
                    markup.add(item1)
...
# Грустное - До встречи с тобой
            ...
            if call.message:
                if call.data == '4.14':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/807318/")
                    markup.add(item1)
...
# Грустное - В метре друг от друга
            ...
            if call.message:
                if call.data == '4.15':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/1151373/")
                    markup.add(item1)
...
# Грустное - Мост в Терабитию
            ...
            if call.message:
                if call.data == '4.16':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/78753/")
                    markup.add(item1)
...
# Грустное - Куда приводят мечты
            ...
            if call.message:
                if call.data == '4.17':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/15139/")
                    markup.add(item1)
...
# Грустное - Виноваты звезды
            ...
            if call.message:
                if call.data == '4.18':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/724703/")
                    markup.add(item1)
...
# Грустное - Я Кристина
            ...
            if call.message:
                if call.data == '4.19':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/55830/")
                    markup.add(item1)
...
# Грустное - Класс
            ...
            if call.message:
                if call.data == '4.20':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/320230/")
                    markup.add(item1)
...
# Загадочное - Другие            
            if call.message:
                if call.data == '4.21':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/494/")
                    markup.add(item1)
...
# Загадочное - Знакомьтесь, Джо Блэк
            if call.message:
                if call.data == '4.22':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/5059/")
                    markup.add(item1)
...
# Загадочное - Дориан Грей
            if call.message:
                if call.data == '4.23':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/415663/")
                    markup.add(item1)
...
# Загадочное - Тело
            ...
            if call.message:
                if call.data == '4.24':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/609349/")
                    markup.add(item1)
...
# Загадочное - Сомния
            ...
            if call.message:
                if call.data == '4.25':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/798086/")
                    markup.add(item1)
...
# Загадочное - Сонная лощина
            ...
            if call.message:
                if call.data == '4.26':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/5622/")
                    markup.add(item1)
...
# Загадочное - Ключ от всех дверей
            ...
            if call.message:
                if call.data == '4.27':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/77673/")
                    markup.add(item1)
...
# Загадочное - Знамение
            ...
            if call.message:
                if call.data == '4.28':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/102510/")
                    markup.add(item1)
...
# Загадочное - Гоголь. Вий
            ...
            if call.message:
                if call.data == '4.29':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1100779/")
                    markup.add(item1)
...
# Загадочное - Приют
            ...
            if call.message:
                if call.data == '4.30':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/119975/")
                    markup.add(item1)
...
# Мотивирующее - Одержимость            
            if call.message:
                if call.data == '4.31':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/725190/")
                    markup.add(item1)
...
# Мотивирующее - Каждое воскресенье
            if call.message:
                if call.data == '4.33':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/1541/")
                    markup.add(item1)
...
# Мотивирующее - Не волнуйся, он далеко не уйдет
            ...
            if call.message:
                if call.data == '4.34':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/1008748/")
                    markup.add(item1)
...
# Мотивирующее - В погоне за счастьем
            ...
            if call.message:
                if call.data == '4.35':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/104938/")
                    markup.add(item1)
...
# Мотивирующее - Человек, который изменил все
            ...
            if call.message:
                if call.data == '4.36':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/432791/")
                    markup.add(item1)
...
# Мотивирующее - Я — Сэм
            ...
            if call.message:
                if call.data == '4.37':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/706/")
                    markup.add(item1)
...
# Мотивирующее - 127 часов
            ...
            if call.message:
                if call.data == '4.38':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/484878/")
                    markup.add(item1)
...
# Мотивирующее - Серфер души
            ...
            if call.message:
                if call.data == '4.39':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/496745/")
                    markup.add(item1)
...
# Мотивирующее - Спасительный рассвет
            ...
            if call.message:
                if call.data == '4.40':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/103726/")
                    markup.add(item1)
...
# Романтичное - 365 дней            
            if call.message:
                if call.data == '4.41':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1298149/")
                    markup.add(item1)
...
# Романтичное - После
            if call.message:
                if call.data == '4.42':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/1098154/")
                    markup.add(item1)
                    bot.send_message(call.message.chat.id,  "*Описание*\n        Будущее. Деспотичное государство ежегодно устраивает показательные игры на выживание, за которыми в прямом эфире следит весь мир. Жребий участвовать в Играх выпадает юной Китнисс и тайно влюбленному в нее Питу. Они знакомы с детства, но теперь должны стать врагами. Ведь по нерушимому закону Голодных игр победить может только один из 24 участников. Судьям не важно кто выиграет, главное - зрелище. И на этот раз зрелище будет незабываемым.", reply_markup=markup, parse_mode="Markdown")
...
# Романтичное - Секретарша
            if call.message:
                if call.data == '4.43':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/820/")
                    markup.add(item1)
...
# Романтичное - Будка поцелуев
            ...
            if call.message:
                if call.data == '4.44':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/1024882/")
                    markup.add(item1)
...
# Романтичное - Предложение
            ...
            if call.message:
                if call.data == '4.45':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/321842/")
                    markup.add(item1)
...
# Романтичное - Звезда родилась
            ...
            if call.message:
                if call.data == '4.46':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма",  url="https://www.kinopoisk.ru/film/474935/")
                    markup.add(item1)
...
# Романтичное - Тепло наших тел
            ...
            if call.message:
                if call.data == '4.47':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/497077/")
                    markup.add(item1)
...
# Романтичное - Пятьдесят оттенков серого
            ...
            if call.message:
                if call.data == '4.48':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/688832/")
                    markup.add(item1)
...
# Романтичное - Золушка
            ...
            if call.message:
                if call.data == '4.49':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/533954/")
                    markup.add(item1)
...
# Романтичное - Он - дракон
            ...
            if call.message:
                if call.data == '4.50':
                    ...
                    bot.send_photo(call.message.chat.id, img)
                    markup = types.InlineKeyboardMarkup(row_width=1)
                    item1 = types.InlineKeyboardButton("Перейти к просмотру фильма", url="https://www.kinopoisk.ru/film/840258/")
                    markup.add(item1)
