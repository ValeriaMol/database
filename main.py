...
def welcome(message):
    sti = open('Bot\static\welcome.webp', 'rb')
    bot.send_sticker(message.chat.id, sti)
    # db_object.execute("INSERT INTO movie_day (id, Дата, Название, Год, Страна, Жанр, Слоган, Режиссер, Сценарий, Картинка, Описание, Ссылка) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);", (1, '2022-05-30', 'Титаник', 1997, 'США, Мексика, Австралия', 'мелодрама, история, триллер, драма', '«Ничто на Земле не сможет разлучить их»', 'Джеймс Кэмерон', 'Джеймс Кэмерон', 'Bot/static/titanic.jpg', 'В первом и последнем плавании шикарного «Титаника» встречаются двое. Пассажир нижней палубы Джек выиграл билет в карты, а богатая наследница Роза отправляется в Америку, чтобы выйти замуж по расчёту. Чувства молодых людей только успевают расцвести, и даже не классовые различия создадут испытания влюблённым, а айсберг, вставший на пути считавшегося непотопляемым лайнера.В первом и последнем плавании шикарного «Титаника» встречаются двое. Пассажир нижней палубы Джек выиграл билет в карты, а богатая наследница Роза отправляется в Америку, чтобы выйти замуж по расчёту. Чувства молодых людей только успевают расцвести, и даже не классовые различия создадут испытания влюблённым, а айсберг, вставший на пути считавшегося непотопляемым лайнера.', 'http://ah.lordfilms-s.tv/44684-film-titanik-1997.html'))
